...
class PensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pen" do
    assert_difference('Pen.count') do
      post pens_url, params: { pen: { description: @pen.description, pen_id: @pen.pen_id, price: @pen.price } }
    end
  ...
  test "should update pen" do
    patch pen_url(@pen), params: { pen: { description: @pen.description, pen_id: @pen.pen_id, price: @pen.price } }
